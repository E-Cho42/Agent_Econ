...
def main_expriment(runId, params, save_output):
    # --- INITIALIZATION ---
    #person parameters:
    savings = rd.uniform(30000, 80000)  
    spendingRate = params["spendingRate"] #rd.uniform(0.6, 0.9)  
    employed = False
    employer = None 
    workRate = params["workRate"]   
    income = 0
    bankruptSpendingRate = params["bankruptSpendingRate"] #.05  
    ...
    #interesting ones:
    price_low_lim = params["price_low_lim"]   #200   
    price_high_lim = params["price_high_lim"]  #1500  
    lower = params["lower"]
